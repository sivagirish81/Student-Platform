...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2019 at 03:24 PM
...
('PES1201701526', 'SSS', 'UE17CS251', 0, '52'),
('PES1201701349', 'JR', 'UE17CS253', 0, '52'),
('PES1201701349', 'SSS', 'UE17CS251', 0, '52'),
('PES1201701349', 'ND', 'UE17MA251', 0, '52'),
('PES1201701349', 'PB', 'UE17CS252', 98, '52'),
('PES1201701349', 'SVI', 'UE17CS254', 0, '52'),
('PES1201700888', 'PB', 'UE17CS252', 91, '49'),
('PES1201701526', 'PB', 'UE17CS252', 60, '37'),
('PES1201700010', 'PB', 'UE17CS252', 0, '36'),
('PES1201700569', 'PB', 'UE17CS252', 0, '39'),
('PES1201700159', 'PB', 'UE17CS252', 90, '48');
...
('PES1201700159', 'UE17CS253', 'JR'),
('PES1201700888', 'UE17CS253', 'JR'),
('PES1201700888', 'UE17CS253', 'JR'),
('PES1201701526', 'UE17CS253', 'JR'),
('PES1201700888', 'UE17CS252', 'PB'),
('PES1201700159', 'UE17CS252', 'PB'),
('PES1201701526', 'UE17CS252', 'PB');
...
CREATE TABLE `exam_department` (
  ...
  `SGPA` double(4,1) NOT NULL,
  `CGPA` double(4,1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('PES1201701349', 'UE17CS251', 40, 35, 100, 1, 10.0, 10.0),
('PES1201701349', 'UE17CS252', 40, 40, 100, 0, 10.0, 10.0),
('PES1201701349', 'UE17MA251', 39, 35, 95, 1, 10.0, 10.0),
('PES1201701349', 'UE17CS253', 38, 35, 95, 0, 10.0, 10.0),
('PES1201701349', 'UE17CS254', 32, 35, 95, 1, 10.0, 10.0),
('PES1201700159', 'UE17CS251', 30, 34, 97, 1, 9.0, 9.0),
('PES1201700159', 'UE17CS252', 31, 36, 87, 1, 9.0, 9.0),
('PES1201700159', 'UE17CS253', 36, 34, 95, 1, 9.0, 9.0),
('PES1201700159', 'UE17CS254', 30, 36, 85, 1, 9.0, 9.0),
('PES1201700159', 'UE17MA251', 36, 34, 100, 1, 9.0, 9.0),
('PES1201700888', 'UE17CS251', 35, 32, 99, 0, 9.1, 9.1),
('PES1201700888', 'UE17CS252', 35, 32, 99, 0, 9.1, 9.1),
('PES1201700159', 'UE17CS252', 35, 32, 99, 0, 9.0, 9.0),
('PES1201701526', 'UE17CS252', 35, 32, 99, 0, 9.1, 9.2),
('PES1201700010', 'UE17CS252', 35, 32, 99, 0, 9.1, 9.2),
('PES1201700569', 'UE17CS252', 35, 32, 99, 0, 9.1, 9.2),
('PES1201701160', 'UE17CS252', 35, 32, 99, 0, 9.1, 9.2);
...
('PES1201700010', 'ROHAN SHARMA', 4, 'B', '1999-11-02', 'M', 95, 95, 'CS', 'PES1201700010', '		1.DAA Assignment On Friday.', '1.LAB ON SATURDAY'),
('PES1201700159', 'R Siva Girish', 4, 'E', '1999-03-22', 'M', 93, 91, 'CS', 'PES1201700159', '1.DBMS Submission on Tuesday', '1.DBMS Project Submission on monday.<br>Submit<br>md md<br>'),
('PES1201700569', 'Aniketh S Bhat', 4, 'B', '1999-11-02', 'M', 95, 95, 'CS', 'PES1201700569', '1.Fluid Mechanics Assignment submission tommorow', '1.Solve Mech problems'),
('PES1201700888', 'Varad Ganesh Rane', 4, 'E', '1999-07-10', 'M', 90, 91, 'CS', 'PES1201700888', '1.DBMS Submission on Tuesday', '1.Have to study for toc.'),
('PES1201701160', 'BHARATH MANOHARAN', 4, 'B', '1999-05-28', 'M', 90, 90, 'CS', 'PES1201701160', '		1.DAA Assignment On Friday.', '1.LAB ON SATURDAY'),
('PES1201701349', 'Mayank Agarwal', 4, 'E', '2000-01-22', 'M', 100, 100, 'CS', 'PES1201701349', '1.DBMS Submission on Tuesday', 'Submit DBMS Project|Finish intel tomorrow| Lab esa day after'),
('PES1201701526', 'Anirudh Avadhani', 4, 'E', '1999-03-28', 'M', 95, 99, 'CS', 'PES1201701526', '1.DBMS Submission on Tuesday', '1.TOC assignment on monday');
