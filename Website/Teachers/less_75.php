    ...
    <div align = "center">
        <div class="row">
            ...
            <div class="col-sm-6" >  <?php 
                ...
                #$stmt = "SELECT Name , attendance FROM attendance as a, stdent as s WHERE a.SSN = s.SSN and a.Course_ID ='".$_POST['course']."' and s.SSN IN (SELECT s.SSN FROM Student as s, course_taken as ct, course as c WHERE s.SEMESTER= '".$_POST['semester']."' and s.Section = '".$_POST['section']."' and s.SSN=ct.SSn and c.course_id = '".$_POST['course']."' and c.course_id = ct.course_id)";
                $stmt = "SELECT DISTINCT SSN,Name FROM student WHERE SSN in ( SELECT A.SSN FROM Attendance as A,  student as s WHERE A.SSN = s.SSN and  A.Course_ID='".$_POST['course']."' and A.Attendance<75 and s.SEMESTER= '".$_POST['semester']."' and s.Section = '".$_POST['section']."' )";
                ...
                <div>
                 ...
                 <pre> <?php  echo $row['SSN']; ?>         <?php  echo $row['Name']; ?></pre> </li>
